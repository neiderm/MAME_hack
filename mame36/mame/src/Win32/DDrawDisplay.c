...
static struct osd_bitmap *DDraw_create_display(int width, int height, int depth, int attributes)
{
    ...
    */
    ...
    InitDirty(width, height, This.m_eDirtyMode);
...
static int DDraw_allocate_colors(unsigned int totalcolors, const unsigned char *palette, unsigned short *pens, int modifiable)
{
    ...
    if (This.m_pMAMEBitmap->depth == 16
    ...
    if (This.m_pMAMEBitmap->depth != 8 && This.m_bModifiablePalette == FALSE)
    {
        int r, g, b;
    ...
    else
    {
        ...
        */
		...
		if (This.m_pMAMEBitmap->depth == 8 && 255 <= totalcolors)
        {
            int bestblack;
            int bestwhite;
            int bestblackscore;
    ...
    */
    ...
    if (This.m_bBltDouble == TRUE)
    {
        This.Render = SelectRenderMethod(FALSE,
                                         ...
                                         FALSE,
                                         This.m_eDirtyMode,
                                         This.m_pMAMEBitmap->depth == 16 ? TRUE : FALSE,
                                         bPalette16,
                                         This.m_p16BitLookup,
...
static void DDraw_save_snapshot()
{
    if (This.m_bAviCapture)
    {
        ...
        Display_WriteBitmap(This.m_pMAMEBitmap, This.m_pPalEntries);
}
...
static void DrawSurface(IDirectDrawSurface* pddSurface)
{
    ...
    if (This.m_bAviRun) /* add avi frame */
        AviAddBitmap(This.m_pMAMEBitmap, This.m_pPalEntries);
...
static BOOL BuildPalette(IDirectDraw2* pDDraw, PALETTEENTRY* pPalEntries, IDirectDrawPalette** ppDDPalette)
{
    ...
    assert(This.m_pMAMEBitmap->depth == 8);
...
static void SetPaletteColors()
{
    ...
    if (This.m_pMAMEBitmap->depth == 16 && This.m_bModifiablePalette == TRUE)
    {
        UINT i;
...
static int FindBlackPen(void)
{    
    if (This.m_pMAMEBitmap->depth == 8 || This.m_bModifiablePalette == TRUE)
    {
        int i;

...
OP(02) {		  m6509_ICount -= 2;		 ILL;		  } /* 2 ILL */
OP(22) {		  m6509_ICount -= 2;		 ILL;		  } /* 2 ILL */
OP(42) {		  m6509_ICount -= 2;		 ILL;		  } /* 2 ILL */
OP(62) {		  m6509_ICount -= 2;		 ILL;		  } /* 2 ILL */
...
OP(12) {		  m6509_ICount -= 2;		 ILL;		  } /* 2 ILL */
OP(32) {		  m6509_ICount -= 2;		 ILL;		  } /* 2 ILL */
OP(52) {		  m6509_ICount -= 2;		 ILL;		  } /* 2 ILL */
OP(72) {		  m6509_ICount -= 2;		 ILL;		  } /* 2 ILL */
OP(92) {		  m6509_ICount -= 2;		 ILL;		  } /* 2 ILL */
OP(b2) {		  m6509_ICount -= 2;		 ILL;		  } /* 2 ILL */
OP(d2) {		  m6509_ICount -= 2;		 ILL;		  } /* 2 ILL */
OP(f2) {		  m6509_ICount -= 2;		 ILL;		  } /* 2 ILL */
...
OP(9e) {		  m6509_ICount -= 2;		 ILL;		  } /* 2 ILL */

 ...
 *
 * $Id: vu.c,v 1.4 1997/07/31 10:56:57 pekangas Exp $
 *
...
RCSID(const char *vu_rcsid = "$Id: vu.c,v 1.4 1997/07/31 10:56:57 pekangas Exp $";)
...
int CALLING vuPrepare(sdSample *sample, unsigned sampleNumber)
{
    ...
    if ( (vuSample->sampleLength == 0) || (
        (vuSample->sampleType != smp8bit) &&
        (vuSample->sampleType != smp16bit))
    ...
    /* FIXME - only mono samples supported! */

    if ( vuSample->sampleType == smp16bit )
    {
        vuSample->sampleLength /= 2;
        is16bit = 1;
    }
    else
    {
...
/*
 * $Log: vu.c,v $
 * Revision 1.4  1997/07/31 10:56:57  pekangas
 * Renamed from MIDAS Sound System to MIDAS Digital Audio System
 *
 * Revision 1.3  1997/02/27 16:05:54  pekangas

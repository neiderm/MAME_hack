/*      rawf_nt.c
 *
 * Win32 raw file I/O for MIDAS Digital Audio System
 *
 * $Id: rawf_nt.c,v 1.4 1997/07/31 10:56:54 pekangas Exp $
 *
...
RCSID(const char *rawf_nt_rcsid = "$Id: rawf_nt.c,v 1.4 1997/07/31 10:56:54 pekangas Exp $";)

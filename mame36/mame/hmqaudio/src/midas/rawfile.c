 ...
 *
 * $Id: rawfile.c,v 1.4 1997/07/31 10:56:54 pekangas Exp $
 *
...
RCSID(const char *rawfile_rcsid = "$Id: rawfile.c,v 1.4 1997/07/31 10:56:54 pekangas Exp $";)
 ...
 *
 * Revision 1.3  1997/05/23 15:09:19  jpaana

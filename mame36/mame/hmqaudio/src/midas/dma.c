 ...
 *
 * $Id: dma.c,v 1.5 1997/07/31 10:56:36 pekangas Exp $
 *
...
RCSID(const char *dma_rcsid = "$Id: dma.c,v 1.5 1997/07/31 10:56:36 pekangas Exp $";)
...
#ifndef __DJGPP__
    /* (cwsdpmi doesn't like this?) */
    if ( (error = dpmiLockMemory(addr, size)) != OK )
        PASSERROR(ID_dmaAllocBuffer);
#endif

#if defined(__FLATMODE__) || defined(__DJGPP__)
...
#ifndef __DJGPP__
    if ( (error = dpmiUnlockMemory(buf->startAddr, buf->bufferLen)) != OK )
        PASSERROR(ID_dmaFreeBuffer);
#endif
...
/*
 * $Log: dma.c,v $
 * Revision 1.5  1997/07/31 10:56:36  pekangas
 * Renamed from MIDAS Sound System to MIDAS Digital Audio System
 *
 * Revision 1.4  1997/02/27 15:59:12  pekangas
 * Added DJGPP support
 *

 ...
 *
 * $Id: nosound.c,v 1.4 1997/07/31 10:56:54 pekangas Exp $
 *
...
RCSID(const char *nosound_rcsid = "$Id: nosound.c,v 1.4 1997/07/31 10:56:54 pekangas Exp $";)
 ...
 *
 * Revision 1.3  1997/02/27 16:06:25  pekangas
 * Fixed card type
 *
